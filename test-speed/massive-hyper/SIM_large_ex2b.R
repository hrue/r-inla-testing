...
# data simulation
nsujet=300 # this number will only increase data size (same number of parameters) ; ideal case 2000
nmarkers=3  # this increases the number of fixed effects and hyperparameters (and data size) ; ideal 20-30
# NHYPER = nmarkers*9+1
